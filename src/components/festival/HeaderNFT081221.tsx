...
const Header: FC<Props> = ({ hideTimeline }) => {
  ...
  const menu = [
    { url: '/connectcon/nft', title: t('nav.events') },
    { url: '/connectcon/nft/speakers', title: t('nav.speakers') },
  ]
        ...
        <div className={clsx('d-flex', styles.header__tabs)}>
          <div
            className={clsx(
              ...
              router.asPath !== '/connectcon/nft/speakers' ? 'selected' : undefined,
            )}
          >
            <Link href='/connectcon/nft'>
          ...
          >
            <Link href='/connectcon/nft/speakers'>
          ...
          <div className={clsx(styles.header__timeline, 'd-flex')}>
            ...
            <div
              className={clsx(
                ...
                router.asPath === '/connectcon/nft' ? 'selected' : undefined,
              )}
            >
              <Link href='/connectcon/nft'>
                <a title={`${t('header_month')}, 8`}>8</a>
              </Link>
            </div>
          </div>
        )}
