  ...
  const team = [
    {
      ...
      name: '@igormonakhov ',
      link: 'https://connect.club/user/igormonakhov?utm_source=membership_united',
    ...
    },
    {
      ...
      name: '@fffilimonov  ',
      link: 'https://connect.club/user/fffilimonov?utm_source=membership_united',
      role: 'Cofounder/ Chief Technology Officer Connect.Club',
    },
    {
      imgSrc: '/united-token-data/img/winmary.png',
      name: '@winmary ',
      link: 'https://connect.club/user/winmary?utm_source=membership_united',
      role: 'Chief Operating Officer Connect.Club',
    },
    {
      imgSrc: '/united-token-data/img/ka3na.png',
      name: '@ka3na ',
      link: 'https://connect.club/user/ka3na?utm_source=membership_united',
      role: 'Chief Product Officer Connect.Club',
    },
    {
      imgSrc: '/united-token-data/img/seanalimov2021.jpg',
      name: '@seanalimov2021 ',
      link: 'https://connect.club/user/seanalimov2021?utm_source=membership_united',
      role: 'Global Program Director',
    },
    {
      imgSrc: '/united-token-data/img/n_kus.png',
      name: '@n_kus ',
      link: 'https://connect.club/user/n_kus?utm_source=membership_united',
